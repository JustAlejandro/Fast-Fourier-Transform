...
//This is someone else's psuedo-random number generator. Thanks to appas on stackoverflow
float rand(vec2 co){
...
void main() {
	...
	vec4 norm = vec4(face_normal.x + rands.x * 0.1, face_normal.y, face_normal.z + rands.y * 0.1,0.0);
